...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    public R accessToken() {
        this.headers.put("Authorization", SPUtils.getInstance().getString("accessToken"));
        return (R) this;
    }
     ...
     * url后加入param
     * <p>
     * /sys/company/info/detail/{param}
     *
     * @param param param
     * @return
     */
    public R append(String param) {
        url += "/" + param;
        return (R) this;
    }
     ...
     * * /sys/company/info/detail/{param}
     *
     * @param key   只起到传参时提示作用
     * @param param param
     */
    public R append(String key, String param) {
        url += "/" + param;
        return (R) this;
    }
