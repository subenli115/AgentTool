...
import com.moxi.agenttool.ui.adapter.ClientRemindAdapter;
 ...
 */
public class ClientRemindFragment extends CommHttpFragment<FragmentBaseCommonBinding, MainViewModel> {
    ...
    public BaseQuickAdapter getAdapter() {
        return new ClientRemindAdapter(R.layout.item_remind_view,mContext);
    }
