...
public class SearchSysParamAdapter extends ArrayAdapter<SysParamsBean> {
    ...
    */
    ...
    public void update(List<SysParamsBean> data){
        mListData.clear();
...
//        view.setTextSize (TypedValue.COMPLEX_UNIT_SP, textSize);
        ...
        if (selectedText != null && selectedText.equals (mString)) {
            view.setBackgroundColor (Color.parseColor("#2A2F49"));
            view.setTextColor (Color.parseColor("#FF7730"));
            // view.setBackgroundDrawable(selectedDrawble);//设置选中的背景图片
        } else {

            view.setTextColor (mContext.getResources ().getColor (R.color.textColor_333));
            if (mSelectType == 0) {
