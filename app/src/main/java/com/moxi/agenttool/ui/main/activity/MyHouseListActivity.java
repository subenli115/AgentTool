...
import com.moxi.agenttool.databinding.ActivityMyHouseListBinding;
import com.moxi.agenttool.ui.adapter.MyHouseTabPagerAdapter;
import com.moxi.agenttool.ui.base.activity.BaseActivity;
import com.moxi.agenttool.ui.main.fragment.ExpireHouseFragment;
 ...
 */
public class MyHouseListActivity extends BaseActivity<ActivityMyHouseListBinding, MainViewModel> {


    private ArrayList<Fragment> mFragments;
    private MyHouseTabPagerAdapter adapter;


    public static void startAction(Context context) {
        Intent starter = new Intent(context, MyHouseListActivity.class);
    ...
    public void initData() {
        ...
        mFragments.add(new ExpireHouseFragment());
        mFragments.add(new ExpireHouseFragment());

        adapter = new MyHouseTabPagerAdapter(getSupportFragmentManager(), mContext, mFragments,false);
