...
public class PreferenceManager {
	...
	private static String SHARED_KEY_CURRENTUSER_MEMBERID = "SHARED_KEY_CURRENTUSER_MEMBERID";
	...
	public void setCurrentUserMemberId(String memberId) {
		editor.putString(SHARED_KEY_CURRENTUSER_MEMBERID, memberId);
		editor.apply();
	}
	public String getCurrentUserMemberId() {
		return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_MEMBERID, "");
	}
	...
	public String getCurrentUserPhone() {
		return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_PHONE, "");
	}
	...
	public String getCurrentUserPwd(){
		return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_USER_PASSWORD, "");
	}
	...
	public String getRestServer(){
		return mSharedPreferences.getString(SHARED_KEY_REST_SERVER, "");
	}
	...
	public String getIMServer(){
		return mSharedPreferences.getString(SHARED_KEY_IM_SERVER, "");
	}
